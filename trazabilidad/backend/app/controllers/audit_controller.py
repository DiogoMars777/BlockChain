...
from app.views.audit_views import (
    BitacoraResponse,
...
router = APIRouter(tags=["Consultar Bitácora y Notificaciones (CU-005)"])
...
def get_bitacora(
    ...
    return AuditController.list_bitacora(db, accion, entidad, skip, limit)
...
def get_notifications(
    ...
    return AuditController.list_notifications(db, current_user, only_unread, skip, limit)
...
def mark_notification_read(
    ...
    return AuditController.mark_notification_read(db, idnotificacion, current_user)
